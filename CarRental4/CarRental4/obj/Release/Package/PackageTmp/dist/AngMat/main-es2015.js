...
let carTypeModal = class carTypeModal {
...
let ManageCarTypesComponent = class ManageCarTypesComponent {
    constructor(router, carService, messageService, dialog) {
        this.router = router;
    ...
    openDialog(car) {
        const dialogRef = this.dialog.open(_carTypeModal__WEBPACK_IMPORTED_MODULE_6__["carTypeModal"], {
            width: '250px',
            data: { car: car }
        });
...
let carsModal = class carsModal {
    constructor(dialogRef, data, carService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.carService = carService;
        this.editedCar = {};
...
let ManageCarsComponent = class ManageCarsComponent {
    constructor(router, carService, messageService, dialog) {
        this.router = router;
        this.carService = carService;
        this.messageService = messageService;
    ...
    openDialog(car) {
        const dialogRef = this.dialog.open(_carsModal__WEBPACK_IMPORTED_MODULE_6__["carsModal"], {
            width: '250px',
...
let ManageReturnsComponent = class ManageReturnsComponent {
    constructor(router, rentalService, messageService, dialog, carService) {
        this.router = router;
    ...
    openDialog(rental) {
        const dialogRef = this.dialog.open(_returnsModal__WEBPACK_IMPORTED_MODULE_7__["returnsModal"], {
            width: '250px',
            data: { rental: rental }
        });
        dialogRef.afterClosed().subscribe(result => {
...
let returnsModal = class returnsModal {
    constructor(dialogRef, rental) {
        this.dialogRef = dialogRef;
        this.rental = rental;
...
let ManageUsersComponent = class ManageUsersComponent {
    constructor(router, userService, messageService, dialog, permission) {
        this.router = router;
    ...
    //MODAL STUFF
    openDialog(user) {
        const dialogRef = this.dialog.open(_userModal__WEBPACK_IMPORTED_MODULE_5__["userModal"], {
            width: '500px',
            data: {
                user: user
            }
...
let userModal = class userModal {
    constructor(dialogRef, data, permission) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.permission = permission;
        this.editedUser = {};
...
let ViewRentalsComponent = class ViewRentalsComponent {
    constructor(rentalService, messageService) {
        this.rentalService = rentalService;
        this.messageService = messageService;
    }
    ngOnInit() {
...
/* harmony import */ var angular_font_awesome__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! angular-font-awesome */ "./node_modules/angular-font-awesome/dist/angular-font-awesome.js");
...
let CheckoutComponent = class CheckoutComponent {
    constructor(carService, rentalService, userService, messageService) {
        this.carService = carService;
        this.rentalService = rentalService;
        this.userService = userService;
        this.messageService = messageService;
    ...
    onSubmit() {
        ...
        this.rentalService.rent(this.rental)
            ...
            .subscribe(data => {
            console.log(data);
            var m = new _services_message_service__WEBPACK_IMPORTED_MODULE_7__["CarMessage"]("Your order has been processed", `Enjoy your car, ${this.loggedUser.UserName}!`);
            this.messageService.changeMessage(m);
        }, error => {
            console.log(error);
        });
...
let CarErrorHandler = class CarErrorHandler {
    constructor(messageService) {
        this.messageService = messageService;
    }
    handleError(error) {
...
let FooterCardsComponent = class FooterCardsComponent {
    constructor() {
        this.carFolder = `./../../assets/cars/`;
        this.carsOfInterest = [];
...
let MessageComponent = class MessageComponent {
    ...
    ngOnInit() {
        this.srvc.message.subscribe(m => { this.display = m.display, this.title = m.title, this.body = m.body, this.remove(this); });
    }
    remove(_this) {
        setTimeout(function () {
...
let RentalsComponent = class RentalsComponent {
    constructor(carService, rentalService, userService, messageService, router) {
        this.carService = carService;
        this.rentalService = rentalService;
        this.userService = userService;
        this.messageService = messageService;
    ...
    getRentals() {
        return this.rentalService.getRentals().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((rentals) => { this.rentals = rentals; }));
    }
    getCarType() {
        return this.carService.carType.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((carType) => { this.carType = carType; }));
    }
    getCars() {
        return this.carService.getCars().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((carsFS) => { this.allCars = carsFS; }));
    }
    viewAllCars() {
...
let SearchCarsComponent = class SearchCarsComponent {
    constructor(carService, router, userService, messageService) {
        this.carService = carService;
        this.router = router;
        this.userService = userService;
        this.messageService = messageService;
    ...
    toggle() {
        ...
        tempCars = this.switch.Manual == false ? tempCars.filter(c => c.Transmission.toString() == _Classes_CarType__WEBPACK_IMPORTED_MODULE_3__["Gear"][0]) : tempCars.filter(c => c);
        tempCars = this.switch.Automatic == false ? tempCars.filter(c => c.Transmission.toString() == _Classes_CarType__WEBPACK_IMPORTED_MODULE_3__["Gear"][1]) : tempCars.filter(c => c);
        ...
        if (this.selected.Text) {
            tempCars = tempCars.filter(c => c.Model.toLowerCase().includes(this.selected.Text) || c.Manufacturer.toLowerCase().includes(this.selected.Text));
        }
    ...
    toggle2() {
        ...
        tempCars = this.switch.Manual == false ? tempCars.filter(c => c.CarType.Transmission.toString() == _Classes_CarType__WEBPACK_IMPORTED_MODULE_3__["Gear"][0]) : tempCars.filter(c => c);
        tempCars = this.switch.Automatic == false ? tempCars.filter(c => c.CarType.Transmission.toString() == _Classes_CarType__WEBPACK_IMPORTED_MODULE_3__["Gear"][1]) : tempCars.filter(c => c);
        tempCars = this.switch.Unavailable == false ? tempCars.filter(c => c.Available == true) : tempCars.filter(c => c);
        if (this.selected.Text) {
            tempCars = tempCars.filter(c => c.CarType.Model.toLowerCase().includes(this.selected.Text) || c.CarType.Manufacturer.toLowerCase().includes(this.selected.Text));
        }
...
let CarDataService = class CarDataService {
    constructor(client) {
        this.client = client;
    ...
    getCarTypes() {
        return this.client.get(this.Url + "CarInfo/GetCarTypes", httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => console.log( /*data*/)));
    }
    findCarTypes(id) {
    ...
    deleteCars(id) {
        return this.client.delete(this.Url + "CarInfo/DeleteCars?id=" + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`deleted no. ${id}`)));
    }
    getCars() {
        return this.client.get(this.Url + "CarInfo/GetCars", httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => console.log( /*JSON.stringify(data)*/)));
    }
    changeCar(car) {
    ...
    editCar(car) {
        return this.client.put(this.Url + "CarInfo/PutCars", car)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => console.log( /*JSON.stringify(data, null, 2)*/)));
    }
    editCarType(carType) {
...
let RentalDataService = class RentalDataService {
    constructor(client) {
        this.client = client;
    ...
    getRentals() {
        return this.client.get(this.Url + "RentalInfo/GetRentals")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => console.log( /*JSON.stringify(data, null, 2)*/)));
    }
    rent(rental) {
        console.log(rental);
...
let UserDataService = class UserDataService {
    constructor(client, messageService) {
        this.client = client;
        this.messageService = messageService;
